  ...
  <v-app id="inspire">
    ...
    >
      ...
      <v-toolbar-title
        ...
        class="ml-0 pl-4"
      >
        <span class="hidden-sm-and-down font-weight-bold text-uppercase letter-spacing-1">painel de controle</span>           
      </v-toolbar-title>
    ...
    >
      <v-card color='grey lighten-5' class='custom-card'>
        <v-card-title class="white--text gray">
          <span class='center grey--text lighten-3 mb-5 pb-5 headline font-weight-light letter-spacing-4'>Adicionar</span>
        </v-card-title>
    ...
    <v-row>
      <v-col       
        ...
        md='6'
        lg="3"       
        v-for="(dataFirst, i) in DashFirstData" 
        :key="i"     
        class='center'       
      >     
        <v-card
    ...
    >
      <v-card color='grey lighten-5' class='custom-card d-flex flex-column align-content-around'>
        ...
        <v-card-content>          
         ...
         <v-card-actions>
          <v-btn        
            class='center mt-5 primary-btn white--text'
            dark     
            large   
...
<script>
  export default {    
    ...
    data: () => ({
      ...
      drawer: null,      
      DashFirstData: [      
      { icon: 'assignment', text: '99', name:'Servico', route: '/empresa-adm/curriculo' },
    
       ],
      items: [
         { icon: 'dashboard', text: 'Dash', name:'Currículo', route: 'empresa/profissional-adm' },
        { icon: 'assignment', text: 'Currículo', name:'Currículo', route: 'empresa/profissional-adm/curriculo' },
      
        { icon: 'mdi-settings', text: 'Configurações', route:"/dashboard/configuracoes" },
        { icon: 'mdi-message', text: 'Responder Mensagens', route:"/dashboard/responder-mensagens" },       
        { icon: 'mdi-cellphone-link', text: 'Ir para o App', route:"/" },             
      ],
    }),
  }
</script>
